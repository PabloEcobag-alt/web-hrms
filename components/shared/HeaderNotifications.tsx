...
import { Bell, CheckCheck, UserPlus, FileText, Clock } from "lucide-react";
...
const notifications = [
  {
    ...
    description: "John Smith completed personal document submission.",
    time: "10m ago",
    icon: UserPlus,
    unread: true,
  },
  {
    ...
    description: "Maria Garcia submitted an overtime request for approval.",
    time: "1h ago",
    icon: Clock,
    unread: true,
  },
  {
    ...
    description: "January 2026 payroll calculation is complete.",
    time: "3h ago",
    icon: FileText,
    unread: false,
  },
